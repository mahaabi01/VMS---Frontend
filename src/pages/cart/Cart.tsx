          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-1/3 bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="flex justify-between mb-2">
                ...
                <p className="text-gray-800 font-medium">Rs. {totalValue}</p>
              </div>
              <div className="flex justify-between mb-2">
                <p className="text-gray-600">Tax (13%)</p>
                <p className="text-gray-800 font-medium">Rs. {(totalValue * 0.13).toFixed(2)}</p>
              </div>
              ...
              <button onClick={() => (window.location.href = "/checkOut")}
                className="mt-6 w-full px-4 py-3 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-600 transition"
                disabled={items.length === 0}
              >
                Proceed to Checkout
              </button>
